...
python3 -u run_longExp.py \
  ...
  --enc_in $num_channels \
  --des 'Exp' \
  --itr 1 --batch_size 32 --learning_rate 0.001 >logs/LongForecasting/$model_name'/'$dataset'_'$seq_len'_'$pred_len'_gelu.log'
...
python3 -u run_longExp.py \
  ...
  --enc_in $num_channels \
  --des 'Exp' \
  --itr 1 --batch_size 32 --learning_rate 0.0001 >logs/LongForecasting/$model_name'/'$dataset'_'$seq_len'_'$pred_len'_gelu.log'
